...
<script type="text/javascript" src="{{ asset('vendor/erendi-menu/scripts.js') }}"></script>
<script type="text/javascript" src="{{ asset('vendor/erendi-menu/scripts2.js') }}"></script>
<script type="text/javascript" src="{{ asset('vendor/erendi-menu/menu.js') }}"></script>
